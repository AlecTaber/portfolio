        ...
        case 'resume':
            return (
                <section className="bg-gray-300 p-4 m-8 rounded-lg shadow- dark:bg-gray-800">
                    ...
                    <a href="../public/Alec Taber Resume 2024.pdf" download="Alec Taber Resume 2024.pdf" className="bg-blue-600 text-white py-2 px-4 rounded-md shadow-md hover:bg-blue-700 absolute left-1/2 transform -translate-x-1/2">Download Resume</a>
